  ...
  <div id="default-carousel" className="relative mb-4 mt-4 ml-4" data-carousel="static">
    ...
    <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item="">
            ...
            <img src="./img/carousel/slide1.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
        </div>
       
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="./img/carousel/slide2.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
        </div>
       
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="./img/carousel/slide3.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
        </div>
    </div>
